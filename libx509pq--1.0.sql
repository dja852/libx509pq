...
CREATE OR REPLACE FUNCTION x509_version(bytea) RETURNS INTEGER
	AS 'MODULE_PATHNAME' LANGUAGE c IMMUTABLE;

CREATE OR REPLACE FUNCTION x509_bcca(bytea) RETURNS BOOLEAN
	AS 'MODULE_PATHNAME' LANGUAGE c IMMUTABLE;

CREATE OR REPLACE FUNCTION x509_hasExtension_critical(bytea,text) RETURNS BOOLEAN
	AS 'MODULE_PATHNAME' LANGUAGE c IMMUTABLE;
	
CREATE OR REPLACE FUNCTION x509_keyusage(bytea) RETURNS integer
	AS 'MODULE_PATHNAME' LANGUAGE c IMMUTABLE;

CREATE OR REPLACE FUNCTION x509_printkeyusage(bytea) RETURNS text
	AS 'MODULE_PATHNAME' LANGUAGE c IMMUTABLE;
